...
public class Lista {
	...
	public void adicionarNoInicio(Object elemento) {
		if(this.totalDeElementos==0) {
			...
			Celula nova = new Celula(this.cabeca, null, elemento);
	...
	public void adicionarNoFim(Object nome) {
		if(this.totalDeElementos==0) {
	...
	public void adiconarPorPosicao(int posicao, Object nome) {
		if (posicao==0) {
			adicionarNoInicio(nome);
		}
	...
	//falta colocar o procurarPorNome
}
